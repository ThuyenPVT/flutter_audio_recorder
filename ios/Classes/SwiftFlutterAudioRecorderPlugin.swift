    ...
    public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        ...
        case "init":
            ...
            guard let destinationUrl = URL(string: mPath) else {
                ...
                print(errorMessage)
                result(FlutterError(code: "", message: errorMessage, details: "Failed to initialize URL path"))
                return
            }
            ...
            do {
                ...
                print("fail")
                result(FlutterError(code: "", message: "Failed to init", details: "Failed to init"))
            }
        case "start":
            print("start")
